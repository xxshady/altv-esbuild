  ...
  constructor(options: FilledPluginOptions) {
    if (options.dev.enabled) {
      ...
      if (options.enhancedAltLog) {
        this.log.warn("enhancedAltLog is deprecated, because it was integrated into alt:V JS module: https://github.com/altmp/altv-js-module/pull/170#issuecomment-1273613155")
        this.hookAltLogging()
      }
    }
  }
